...
export function transformReading(reading) {
  return {
    ...
    // MySQL retorna DECIMAL como string — convertir a número
    temperatura_c: reading.temperatura_c != null ? parseFloat(reading.temperatura_c) : null,
    mA_raw:        reading.mA_raw        != null ? parseFloat(reading.mA_raw)        : null,
    gps: {
      latitude:  reading.latitud       != null ? parseFloat(reading.latitud)       : null,
      longitude: reading.longitud      != null ? parseFloat(reading.longitud)      : null,
      altura:    reading.altura_m      != null ? parseFloat(reading.altura_m)      : null,
      speed:     reading.velocidad_kmh != null ? parseFloat(reading.velocidad_kmh) : null,
      timestamp: reading.gps_timestamp ?? null,
    },
  }
}
